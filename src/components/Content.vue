<template>
    <div>
        <b-jumbotron>
            ...
            <hr class="my-4">
            <b-list-group v-for="(answer,i) in shuffledAnswers" :key="i" @click="ChangeIndex(i)">
                <b-list-group-item :class="correctFunc(i)">{{answer}}</b-list-group-item>
            </b-list-group>


            <b-button variant="primary" href="#" @click="submitAnswer" :disabled="cindex === null || answered">Submit</b-button>
